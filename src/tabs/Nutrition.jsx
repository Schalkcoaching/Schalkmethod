...
const FOOD_LIBRARY = [
  ...
  { id: 'chicken_bone_broth', name: 'Chicken Bone Broth', category: 'Poultry',  icon: '🍲', caloriesPer100: 12,  unit: 'ml', defaultAmount: 300, nutrients: { collagen: 0.8, glycine: 0.8, proline: 0.7, calcium: 0.3, magnesium: 0.2, phosphorus: 0.3 } },
  // ── Lamb ──
  ...
  { id: 'lamb_liver',  name: 'Lamb Liver',          category: 'Lamb',         icon: '🫀', caloriesPer100: 168, unit: 'g', defaultAmount: 25,  nutrients: { vit_a: 0.9, vit_b2: 0.9, vit_b12: 1, vit_b9: 0.8, choline: 0.8, copper: 0.8, iron: 0.8, zinc: 0.6, selenium: 0.7 } },
  // ── Pork ──
  ...
  { id: 'pecans',      name: 'Pecans',              category: 'Nuts & Seeds',  icon: '🌰', caloriesPer100: 691, unit: 'g',  defaultAmount: 30,  nutrients: { manganese: 0.9, vit_b1: 0.3, copper: 0.3, zinc: 0.3 } },
